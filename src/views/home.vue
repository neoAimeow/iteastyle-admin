        ...
        <div class="menu is-dark" style="display:flex;flex-direction:column;">
          ...
          <div>
            <menus v-for="(section,key) in menus" :key="key" :label="key">
              <menu-item v-for="(menu,index) in section" :key="index" :icon="menu.icon" :is-active="true" :to="{ path: menu.path, query: {}}">
                <span>{{menu.title}}</span>
                <menus slot="sub">
                  <menu-item v-for="(submenu,index) in menu.subMenu" :key="index" :icon="submenu.icon" :is-active="true" :to="{ path: submenu.path, query: {}}">
